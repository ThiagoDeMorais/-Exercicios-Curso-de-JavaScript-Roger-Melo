...
const summerMessageLowercase = summerMessage.toLowerCase();
// console.log(summerMessage, summerMessageLowercase)
...
// console.log(winterMessage.toLowerCase());
/*
...
// console.log(winterMessage.length - 1)
const lasN = winterMessage.lastIndexOf('n');
// console.log(lasN);
...
const realBestMovie = bestMovie.replace("La la land", "Lord Of The Rings")
...
const message = newName.toLowerCase();
console.log(message);